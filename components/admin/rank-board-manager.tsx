...
export default function RankBoardManager({
  ...
  return (
    <div className="space-y-4">
      ...
      {boards.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-zinc-800 px-5 py-10 text-center text-sm text-zinc-400">
          当前还没有可管理的战力榜数据，请先确认数据库中已经存在榜单记录。
        </div>
      ) : (
